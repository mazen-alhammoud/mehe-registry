...
const STEPS = [
  {
    num: 1,
    title: "Platform Infrastructure & Identity Control",
    tagline: "The platform operates under Ministry identity and enforces secure digital execution by design.",
    bullets: [
      "Enforcing role-based access permissions",
      "Assigning secure, individualized login credentials",
      "Activating time-bound access windows",
      "Locking navigation within the competition interface",
      "Preventing page switching or external browsing",
      "Enforcing automatic submission at time expiry",
    ],
    closing: "Security is embedded at system level — not dependent solely on supervision.",
    images: [step1Img1, step1Img2, step1Img3, step1Img4],
  },
  {
    num: 2,
    title: "Identity & Seating Logic",
    tagline: "Each participant receives a unique digital account, a personalized admission ticket, and a randomized seating assignment.",
    bullets: [
      "A unique digital account per participant",
      "A personalized digital admission ticket",
      "A randomized cinema-style classroom and seating assignment",
      "Identity, classroom, seating, and credentials digitally linked",
    ],
    closing: "Fairness is not procedural — it is engineered.",
    images: [step2Img1, step2Img2, step2Img3, step2Img4],
  },
  {
    num: 3,
    title: "National Digital Competition",
    tagline: "Standardized conditions. Synchronized nationally. Observed in real time.",
    bullets: [
      "Automated randomized seating enforced on arrival",
      "Admission ticket verification at entry",
      "Secure device-based competition environment",
      "Central live monitoring at Ministry HQ",
    ],
    closing: "No pre-assigned clustering.\nNo uncontrolled movement.\nNo physical paper circulation.",
    images: [step3Img1, step3Img2, step3Img3, step3Img4, step3Img5],
  },
  {
    num: 4,
    title: "Automated Scoring & Integrity Controls",
    tagline: "Immediate. Consistent. Unbiased.",
    bullets: [
      "Automatic digital scoring",
      "Identity-blind correction",
      "Uniform marking standards across all schools",
      "Anomaly detection and behavioral flags",
    ],
    closing: "Human variability removed from the grading process.",
    images: [step4Img1, step4Img2, step4Img3, step4Img4, step4Img5, step4Img6, step4Img7],
  },
  {
    num: 5,
    title: "Reporting & System-Level Insight",
    tagline: "Evidence replaces assumption. Data becomes decision support.",
    bullets: [
      "Student-level performance reports",
      "School and regional dashboards",
      "Skills and equity analysis",
      "Operational stability metrics",
    ],
    closing: "Structured analytics delivered to the Ministry.",
